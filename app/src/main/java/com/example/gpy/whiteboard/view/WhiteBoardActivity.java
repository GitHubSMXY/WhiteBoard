...
//        mRlContent.setLayoutParams(mLayoutParams);
    ...
    public void eventReceive(Events events) {//文字编辑
        if (events.value.equals(Events.WHITE_BOARD_TEXT_EDIT)) {
            textEdit();
        } else if (events.value.equals(Events.WHITE_BOARD_UNDO_REDO)) {
            showUndoRedo();
        }
    }
